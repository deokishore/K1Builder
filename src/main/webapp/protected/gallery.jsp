...
<section id="portfolio">
            <div class="container">
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-6 image-wrapping">
                    		<div id="page">
                    			<div id="container">
                                        ...
                                        <div class="panel panel-default">
                                          <div class="panel-heading">
                                            <h4 class="panel-title">
                                              <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Bathrooms</a>
                                            </h4>
                                          </div>
...
<!-- End Advanced Gallery Html Containers -->
                                        ...
                                        <div class="panel panel-default">
                                          <div class="panel-heading">
                                            <h4 class="panel-title">
                                              <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Kitchens</a>
                                            </h4>
                                          </div>
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				...
				$('div.navigation').css({'width' : '30%', 'float' : 'right'});
				...
				var gallery = $('#thumbs1').galleriffic({
					...
					onSlideChange:             function(prevIndex, nextIndex) {
						// 'this' refers to the gallery, which is an extension of $('#thumbs1')
						this.find('ul.thumbs1').children()
				...
				// Kitchens - Initialize Advanced Galleriffic Gallery
					var gallery2 = $('#thumbs2').galleriffic({
						...
						defaultTransitionDuration: 900,
						onSlideChange:             function(prevIndex, nextIndex) {
							// 'this' refers to the gallery, which is an extension of $('#thumbs2')
							this.find('ul.thumbs2').children()
								.eq(prevIndex).fadeTo('fast', onMouseOutOpacity).end()
								.eq(nextIndex).fadeTo('fast', 1.0);
						},
						onPageTransitionOut:       function(callback) {
					...
					// Kitchens - Initialize Advanced Galleriffic Gallery
						var gallery3 = $('#thumbs3').galleriffic({
							...
							defaultTransitionDuration: 900,
							onSlideChange:             function(prevIndex, nextIndex) {
								// 'this' refers to the gallery, which is an extension of $('#thumbs3')
								this.find('ul.thumbs3').children()
									.eq(prevIndex).fadeTo('fast', onMouseOutOpacity).end()
									.eq(nextIndex).fadeTo('fast', 1.0);
							},
							onPageTransitionOut:       function(callback) {
