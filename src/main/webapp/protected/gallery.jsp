	...
	<head>
		...
		<link rel="stylesheet" href="/resources/css/galleriffic/basic.css" type="text/css" />
		<link rel="stylesheet" href="/resources/css/galleriffic/galleriffic-2.css" type="text/css" />
		<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">

		<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>
		<script type="text/javascript" src="/resources/js/galleriffic/jquery.galleriffic.js"></script>
		<script type="text/javascript" src="/resources/js/galleriffic/jquery.opacityrollover.js"></script>
